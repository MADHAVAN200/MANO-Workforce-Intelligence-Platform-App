...
class ShiftActionSheet extends StatelessWidget {
  ...
  static void show(BuildContext context, {required String shiftName, required VoidCallback onEdit, required VoidCallback onDelete}) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (context) => ShiftActionSheet(shiftName: shiftName, onEdit: onEdit, onDelete: onDelete),
    );
  }
